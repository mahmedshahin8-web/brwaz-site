    ...
    <div className="bg-[#121214]  border border-[#27272a] p-10 space-y-8 relative overflow-hidden rounded-3xl shadow-sm min-h-[600px]">
      <div className="flex justify-between items-center border-b border-[#27272a] pb-6 mb-8 text-right">
        <div className="flex gap-4">
            <button className="bg-[#4f46e5] text-[#121214] px-4 py-2 rounded-xl text-[10px] font-bold   font-arabic flex items-center gap-2 active:scale-95 transition-all">
                <Send size={14} /> Schedule Deployment
            </button>
        </div>
        <div>
            <h3 className="text-xl font-bold   text-[#f4eee0] font-arabic flex items-center gap-2 justify-end">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-4 space-y-6">
           <h4 className="text-[10px]  font-arabic text-[#71717a]  font-bold mb-4">Integrations</h4>
           ...
           <div className="bg-[#27272a]/50 border border-[#27272a] p-4 rounded-xl flex items-center justify-between group cursor-pointer hover:border-[#ff0000]/50 transition-colors">
              <div className="flex items-center gap-3">
                  ...
                  <div>
                      <p className="text-[#fafafa] font-bold text-xs font-arabic">YouTube_Main</p>
                      <p className="text-[9px] text-green-500 font-arabic ">Connected</p>
                  </div>
              </div>
           ...
           <div className="bg-[#27272a]/50 border border-[#27272a] p-4 rounded-xl flex items-center justify-between group cursor-pointer hover:border-[#E1306C]/50 transition-colors">
              <div className="flex items-center gap-3">
                  ...
                  <div>
                      <p className="text-[#fafafa] font-bold text-xs font-arabic">IG_Reels_Feed</p>
                      <p className="text-[9px] text-[#71717a] font-arabic  flex items-center gap-1"><LinkIcon size={8}/> Connect</p>
                  </div>
              </div>
           </div>
           ...
           <div className="bg-[#27272a]/50 border border-[#27272a] p-4 rounded-xl flex items-center justify-between group cursor-pointer hover:border-[#1DA1F2]/50 transition-colors">
              <div className="flex items-center gap-3">
                  ...
                  <div>
                      <p className="text-[#fafafa] font-bold text-xs font-arabic">X_Timeline</p>
                      <p className="text-[9px] text-[#71717a] font-arabic  flex items-center gap-1"><LinkIcon size={8}/> Connect</p>
                  </div>
              </div>
           </div>
        ...
        <div className="lg:col-span-8 space-y-6 relative">
            <h4 className="text-[10px]  font-arabic text-[#6366f1]  font-bold mb-4 text-right">Deployment Graph</h4>
            ...
            <div className="flex gap-2 justify-end mb-6">
                {["Today", "Tomorrow", "Weekend"].map(day => (
                    <button 
                      ...
                      className={`px-4 py-1.5 rounded-full text-[10px] font-arabic font-bold  transition-all ${selectedDate === day ? "bg-[#6366f1] text-[#121214]" : "bg-[#27272a] text-[#71717a] hover:text-[#4f46e5]"}`}
                    >
                        {day}
                    </button>
                ))}
            ...
            <div className="space-y-4">
                ...
                <div className="bg-[#121214] border border-[#ff0000]/30 border-r-4 border-r-[#ff0000] p-6 rounded-xl flex justify-between items-center group relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-4 relative z-10">
                        <button className="text-[10px] bg-[#27272a] hover:bg-[#ff0000]/20 text-[#71717a] hover:text-[#ff0000] px-3 py-2 rounded-lg font-arabic font-bold  transition-colors ">
                            Edit Slot
                        </button>
                    </div>
                    <div className="text-right relative z-10">
                        <h5 className="font-bold text-[#fafafa] font-arabic text-lg mb-1">{data.video_title}</h5>
                        <p className="text-[10px] text-[#71717a] font-arabic  flex items-center gap-2 justify-end">
                ...
                <div className="bg-[#121214] border border-[#E1306C]/30 border-r-4 border-r-[#E1306C] p-6 rounded-xl flex justify-between items-center group relative overflow-hidden opacity-80">
                    <div className="flex items-center gap-4 relative z-10">
                        <button className="text-[10px] bg-[#27272a] hover:bg-[#E1306C]/20 text-[#71717a] hover:text-[#E1306C] px-3 py-2 rounded-lg font-arabic font-bold  transition-colors ">
                            Edit Slot
                        </button>
                    </div>
                    <div className="text-right relative z-10">
                ...
                <div className="bg-[#121214] border border-[#1DA1F2]/30 border-r-4 border-r-[#1DA1F2] p-6 rounded-xl flex justify-between items-center group relative overflow-hidden opacity-60">
                    <div className="flex items-center gap-4 relative z-10">
                        <button className="text-[10px] bg-[#27272a] hover:bg-[#1DA1F2]/20 text-[#71717a] hover:text-[#1DA1F2] px-3 py-2 rounded-lg font-arabic font-bold  transition-colors ">
                            Edit Slot
                        </button>
                    </div>
                    <div className="text-right relative z-10">
