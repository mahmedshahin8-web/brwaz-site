...
export const EliteTestPanel: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto my-12" dir="rtl">
      ...
      <div className="relative p-8 bg-[#27272a]/50  border border-[#27272a] rounded overflow-hidden">
        
        {/* Subtle glowing accent using Berwaz Red */}
        <div className="absolute -top-24 -right-24 w-48 h-48 bg-[#ef4444]/20 blur-[80px] rounded-full pointer-events-none" />
        ...
        <div className="grid grid-cols-2 gap-4 mb-8 relative z-10">
          <StatsBox 
            icon={<Cpu className="w-4 h-4 text-[#71717a]" />}
            label="معالج_البيانات"
            value="Ollama (Local)"
            status="مُفعل"
          />
          <StatsBox 
            icon={<Activity className="w-4 h-4 text-[#71717a]" />}
            label="معدل_التدفق"
            value="42.8 ms"
            status="مستقر"
          />
