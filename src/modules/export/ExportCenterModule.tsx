...
export const ExportCenterModule: React.FC<ExportCenterProps> = ({ fragmenterData, finalVoiceScript, data }) => {
  ...
  return (
    <div className="bg-[#111722]/60 backdrop-blur-md border border-[#17202c] rounded-2xl p-4 shadow-subtle flex flex-col gap-3">
      <span className="text-[10px] font-mono font-bold text-[#6d6964] tracking-widest uppercase mb-1">Export Center (تصدير الحزم)</span>
      ...
      {isLoading ? (
        <div className="flex flex-col items-center justify-center p-4 border border-[#17202c] rounded-xl bg-[#0a0f16]/80 text-[#a8a09f] gap-3">
          ...
          <span className="text-xs font-arabic tracking-widest">{status}</span>
        </div>
      ) : (
        <div className="flex flex-col gap-3">
          <div className="flex flex-col gap-1">
            <button
              ...
              className="w-full px-4 py-3 bg-[#17202c]/80 text-[#a8a09f] hover:bg-[#1f2937] hover:text-[#d4a574] font-bold active:scale-95 text-xs font-arabic tracking-widest flex items-center justify-center gap-2 transition-all rounded-xl border border-[#17202c]"
            >
          ...
          <div className="flex flex-col gap-1">
            <button
              ...
              className="w-full px-4 py-3 bg-[#1a0f14]/80 text-[#d48a8a] hover:bg-[#2d1b22] hover:text-[#f0a8a8] font-bold active:scale-95 text-xs font-arabic tracking-widest flex items-center justify-center gap-2 transition-all rounded-xl border border-[#3d242e]"
            >
              <Download className="w-4 h-4" />
          ...
          <div className="flex flex-col gap-1">
            <button
              ...
              className="w-full px-4 py-3 bg-gradient-to-r from-[#17202c] to-[#1e1b4b] text-[#a5b4fc] hover:from-[#1e293b] hover:to-[#312e81] hover:text-[#c7d2fe] font-bold active:scale-95 text-xs font-arabic tracking-widest flex items-center justify-center gap-2 transition-all rounded-xl border border-[#3730a3] shadow-[0_0_15px_rgba(55,48,163,0.2)]"
            >
              <Download className="w-4 h-4" />
          ...
          <div className="flex flex-col gap-1">
            <button
              ...
              className="w-full px-4 py-3 bg-[#2b5797] text-[#f5f3f0] hover:bg-[#1e3d6b] font-bold active:scale-95 text-xs font-arabic tracking-widest flex items-center justify-center gap-2 transition-all rounded-xl border border-[#2b5797]/50 shadow-[0_0_15px_rgba(43,87,151,0.2)]"
            >
              <Download className="w-4 h-4" />
              ملف Production (Word)
            </button>
